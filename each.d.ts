...
/**
 * Render a list by key. `key` is a key selector function returning the
 * key to use and `child` is a function returning a child vnode.
 *
...
export default function each<T>(
    ...
    child: (value: T, index: number) => Mithril.Vnode<any, any>
